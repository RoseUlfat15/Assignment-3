...
void main() {
  ...
  // We use the containsKey method to check if the cart contains the key "Apple"
  if (shoppingCart.containsKey('Apple')) {
    print(
        'Product found'); //if a product named "Apple" exists in the cart. Print "Product found
  }
